...
void overall_status::set_all(int check)
{
    if (check == 1)
    {
        QFile file("C:/Users/3atae/Desktop/project/" + managment::username + '/' + project_window_1::project_name + "/all_users.txt");
        ...
        file.close();
        QFile file_2("C:/Users/3atae/Desktop/project/" + managment::username + '/' + project_window_1::project_name + "/all_tasks.txt");
